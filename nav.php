...
<ul class="nav nav-pills pull-right" style="padding-top: 15px;margin-bottom:0">
  ...
  <li class="dropdown">
    <a href="tenderingservices.php" class="dropdown-toggle" data-toggle="dropdown">Our Services <b class="caret"></b></a>
    <ul class="dropdown-menu">
      <li class="dropdown-submenu">
        <a tabindex="-1" href="tenderingservices.php">Tendering Services</a>
        <ul class="dropdown-menu">
          <li><a href="activetenders.php">Tenders</a></li>
          <li><a href="jvpartners.php">JV Proposals</a></li>
        </ul>
      </li>
      <li class="dropdown-submenu">
      ...
      <li><a href="humanresources.php">HR Services</a></li>
      <li><a href="plantmachinery.php">P&M Bridging</a></li>
      <li><a href="financeaccounting.php">Finance & Accounting</a></li>
      <li><a href="civilconsultancyservices.php">Consultancy Services</a></li>
 ...
 <li><a href="registration.php"><span class="badge badge-success"> Register/Sigin </span></a></li>
</ul>
